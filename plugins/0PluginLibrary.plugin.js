 ...
 * @updateUrl https://raw.githubusercontent.com/headxdev/better-discord-plugins-and-themes/refs/heads/main/plugins/0PluginLibrary.plugin.js
 */
...
class ReactTools {
    ...
    static wrapElement(element) {
        ...
        return class ReactWrapper extends _discordmodules__WEBPACK_IMPORTED_MODULE_1__["default"].React.Component {
            ...
            render() {return _discordmodules__WEBPACK_IMPORTED_MODULE_1__["default"].React.createElement("div", {className: "react-wrapper", ref: (e) => {if (!this.refs) this.refs = {}; this.refs.element = e;}});}
        };
    }
}
