 ...
 * @updateUrl https://raw.githubusercontent.com/headxdev/better-discord-plugins-and-themes/refs/heads/main/plugins/ShowHiddenChannels.plugin.js
...
const config = {
	...
	changelog: [{"title":"v0.6.4 - Fix missing function error","items":["Changed getRoles to getRolesSnapshot in Lockscreen.jsx to fix a missing function error."]},{"title":"v0.6.3 - Minor Changes","items":["Added a support server link to the plugin settings buttons.","Refactored bigint in date.js","Fixed an error in the Lockscreen.jsx file."]},{"title":"v0.6.2 - Fix Hidden Channel Page","items":["Fixed the hidden channel page making discord crash due to the new Discord update."]}],
