 ...
 * @updateUrl https://raw.githubusercontent.com/headxdev/better-discord-plugins-and-themes/refs/heads/main/plugins/PasscodeLock.plugin.js
 */
...
.PCL--layout-bg {
    ...
    background: linear-gradient(135deg, rgba(15, 20, 40, 0.99) 0%, rgba(10, 12, 25, 0.99) 50%, rgba(20, 25, 50, 0.99) 100%);
    box-shadow: inset 0 0 100px rgba(88, 101, 242, 0.1), 0 0 50px rgba(0, 0, 0, 0.5);
