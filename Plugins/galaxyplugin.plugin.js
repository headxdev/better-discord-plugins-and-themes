    ...
    applyTransparencyFixes() {
        ...
        style.textContent = `
            ...
            .chat-2ZfjoI, .chat-3bRxxu, .chatContent-a9vAAp {
                background: rgba(10, 12, 25, 0.4) !important;
            }
            ...
            .guilds-2JjMmN, .guilds-1SWlCJ, .wrapper-1_HaEi {
                background: rgba(8, 10, 20, 0.6) !important;
            }
            
            /* SpotifyControls Kompatibilität */
            ...
            /* MessageLoggerV2 Kompatibilität */
            ...
            /* PingNotification Kompatibilität */
            .ping-notification-container, [class*="notification"] {
                backdrop-filter: blur(12px) !important;
            }
            
            /* PasscodeLock Kompatibilität */
            .passcode-lock-overlay {
                backdrop-filter: blur(20px) !important;
            }
            
            /* VoiceActivity Kompatibilität */
            [class*="voiceActivity"] {
